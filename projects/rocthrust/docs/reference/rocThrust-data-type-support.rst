.. meta::
   :description: rocThrust library precision support
   :keywords: rocThrust, ROCm, API library, API reference, data type, support, precision

.. _rocthrust-data-type-support:

******************************************
rocThrust precision support
******************************************

This topic lists the data type support for the rocThrust library on AMD GPUs.
...
.. _rocthrust-input-output-type-support:

Supported data types
====================

The following table lists the input and output data types supported by
rocThrust.
