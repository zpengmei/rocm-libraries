...
TEST_F(TestSdpaFwdPlanBuilder, MaskBoundsTrioSymmetricWindowDerivesWindowGeneric)
{
    using namespace hipdnn_flatbuffers_sdk::data_objects;
...
TEST_F(TestSdpaFwdPlanBuilder, MaskBoundsTrioLeftOnlyDerivesWindowGeneric)
{
    using namespace hipdnn_flatbuffers_sdk::data_objects;
