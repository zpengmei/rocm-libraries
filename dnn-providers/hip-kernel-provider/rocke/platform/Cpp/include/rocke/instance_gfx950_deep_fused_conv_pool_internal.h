 ...
 *
 * rocke/instance_gfx950_deep_fused_conv_pool_internal.h -- PRIVATE shared state +
 ...
 *   (rocke/instances/gfx950/deep_fused_conv_pool.py  ->
 ...
 *   rocke_gfx950_dfcp_build_ctx_t, which holds EXACTLY the variables the closures
 *   share. The gfx950 public driver
 *   (rocke_build_gfx950_deep_fused_conv_pool in
 *    rocke/instance_gfx950_deep_fused_conv_pool.h) stamps the MFMA geometry/name
 ...
 *   rocke_dfcp_* phases). This gfx950 surface is a SEPARATE, parallel set of
 *   symbols carrying the rocke_gfx950_dfcp_ / gfx950_deep_fused_conv_pool prefix so
 ...
 *   reuse the ported common emit/pure helpers (rocke_dfcp_* from
 ...
 *   rocke/helper_rocke.helpers.loads.h, rocke_make_lds_view / rocke_tensor_view_t from
 *   rocke/helper_rocke.helpers.tensor_view.h, and the full rocke_mma_op_t struct
 *   from rocke/arch_target.h via the helper alias).
 *
 ...
 *   path (rocke_dfcp_maxpool_is_intra_lane + rocke_dfcp_emit_inline_maxpool_from_
 *   registers). For gfx950 this fast path is ACTIVE. The WMMA register-resident
 *   maxpool (rocke_dfcp_emit_wmma_maxpool_from_registers, gated by
 *   rocke_dfcp_maxpool_is_intra_lane_wmma) is INACTIVE here -- it is the gfx1201
 ...
 *   (rocke_dfcp_emit_inline_maxpool_from_cshuffle), exactly as in the common body.
 *
 ...
 *   the Python closure names with a `rocke_gfx950_dfcp_` prefix.
 *
 ...
 * rocke/instance_gfx950_deep_fused_conv_pool.h.
 */
#ifndef ROCKE_INSTANCE_GFX950_DEEP_FUSED_CONV_POOL_INTERNAL_H
#define ROCKE_INSTANCE_GFX950_DEEP_FUSED_CONV_POOL_INTERNAL_H

#include <stdbool.h>
#include <stddef.h>

#include "rocke/helper_rocke.instances.common.deep_fused_conv_pool.h"
#include "rocke/instance_gfx950_deep_fused_conv_pool.h" /* public gfx950 spec + build entry */
#include "rocke/ir.h"
 ...
 * (rocke_dfcp_*) the gfx950 closures reuse. */
 ...
 * convention. */
#define ROCKE_GFX950_DFCP_MAX_ACCS 64

/* ===================================================================== *
 *  rocke_gfx950_dfcp_build_ctx_t
 *
 ...
 *  builder hands in.
 * ===================================================================== */
typedef struct rocke_gfx950_dfcp_build_ctx
{
    /* =============================================================== *
     * (A) BUILD-TIME CONSTANTS -- set once by
     *     rocke_build_gfx950_deep_fused_conv_pool before calling
    ...
    const rocke_gfx950_deep_fused_conv_pool_spec_t* spec; /* the gfx950-pinned spec   */
     ...
     * per-warp tile count. */
    rocke_value_t* conv0_accs[ROCKE_GFX950_DFCP_MAX_ACCS];
    size_t num_conv0_accs;
    rocke_value_t* conv1_accs[ROCKE_GFX950_DFCP_MAX_ACCS];
 ...
 * (rocke_dfcp_emit_inline_maxpool_from_registers when
 ...
 * (rocke_dfcp_emit_wmma_maxpool_from_registers) is NOT reachable from this gfx950
...
#endif /* ROCKE_INSTANCE_GFX950_DEEP_FUSED_CONV_POOL_INTERNAL_H */
